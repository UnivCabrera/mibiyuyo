...
2. [Análisis del Mercado Mexicano](#2-análisis-del-mercado-mexicano)
3. [Propuesta de Valor Única](#3-propuesta-de-valor-única)
4. [Los 40 Perfiles Profesionales](#4-los-40-perfiles-profesionales)
5. [Necesidades No Resueltas (Top 30)](#5-necesidades-no-resueltas-top-30)
6. [Arquitectura del Producto](#6-arquitectura-del-producto)
7. [Módulos Core (Obligatorios)](#7-módulos-core-obligatorios)
8. [Módulos Premium](#8-módulos-premium)
9. [Gamificación Neurocognitiva](#9-gamificación-neurocognitiva)
10. [UX/UI con Neurociencia Aplicada](#10-uxui-con-neurociencia-aplicada)
11. [Psicología Persuasiva Positiva](#11-psicología-persuasiva-positiva)
...
16. [Framework de Evolución](#16-framework-de-evolución)
...
┌─────────────────────────────────────────────────────────────────────────┐
│                                                                         │
│   "Ser la plataforma financiera que transforme la relación de          │
│    10 millones de mexicanos con su dinero, convirtiendo el             │
│    estrés financiero en confianza y control."                          │
│                                                                         │
└─────────────────────────────────────────────────────────────────────────┘
```
...
> **Democratizar el bienestar financiero** para cada mexicano, sin importar su nivel de ingresos o conocimiento, utilizando tecnología de clase mundial y principios de neurociencia para crear hábitos financieros positivos.
...
## 2. ANÁLISIS DEL MERCADO MEXICANO

### 2.1 Tamaño de Mercado

```
MERCADO TOTAL ADDRESSABLE (TAM): 60 millones de mexicanos
                                 (Población bancarizada + semi-bancarizada)

MERCADO SERVICEABLE (SAM):       25 millones
                                 (Profesionistas + emprendedores + hogares)

MERCADO OBTAINABLE (SOM):        2.5 millones (10% en 3 años)
```
...
┌─────────────────────────────────────────────────────────────────────────┐
│                                                                         │
│   "La primera app financiera diseñada con NEUROCIENCIA para           │
│    MEXICANOS: entiende tu quincena, tu efectivo, tu estrés,           │
│    y te ayuda a gastar SIN CULPA porque ya ahorraste."                │
│                                                                         │
└─────────────────────────────────────────────────────────────────────────┘
```
...
## 4. LOS 40 PERFILES PROFESIONALES
...
## 5. NECESIDADES NO RESUELTAS (TOP 30)
...
│  Svelte 5 + SvelteKit + PWA + Offline-First                            │
├─────────────────────────────────────────────────────────────────────────┤
│                          CAPA DE EXPERIENCIA                            │
│  Neurofinanzas Framework + Gamificación + Tangram UI                   │
├─────────────────────────────────────────────────────────────────────────┤
│                          CAPA DE LÓGICA                                 │
│  ElysiaJS + Bun + TypeScript + Drizzle ORM                             │
├─────────────────────────────────────────────────────────────────────────┤
│                          CAPA DE DATOS                                  │
│  PostgreSQL + Redis + IndexedDB (local)                                 │
├─────────────────────────────────────────────────────────────────────────┤
│                          CAPA DE IA                                     │
│  Gemini Pro + EmbeddingGemma + RAG Pipeline                            │
└─────────────────────────────────────────────────────────────────────────┘
```
...
## 7. MÓDULOS CORE (OBLIGATORIOS)

### 7.1 Mapa de Módulos Gratuitos
...
│                                                                         │
│  ┌─────────────┐  ┌─────────────┐  ┌─────────────┐  ┌─────────────┐   │
│  │  WALLET     │  │ PLANIFICADOR│  │   METAS     │  │   DEUDAS    │   │
│  │  MEXICANO   │  │  QUINCENAL  │  │INTELIGENTES │  │   NEURO     │   │
│  │             │  │             │  │             │  │             │   │
│  │  • Registro │  │  • Vista    │  │  • 3 metas  │  │  • 3 deudas │   │
│  │  • Efectivo │  │    quincenal│  │  • Scaffold │  │  • Reframe  │   │
│  │  • Categorías│  │  • Día/día  │  │  • Progress │  │  • Ruta     │   │
│  └─────────────┘  └─────────────┘  └─────────────┘  └─────────────┘   │
│                                                                         │
│  ┌─────────────┐  ┌─────────────┐  ┌─────────────┐                     │
│  │  TU DINERO  │  │ ANTI-GASTO  │  │   GAMIFI-   │                     │
│  │    HOY      │  │  IMPULSIVO  │  │   CACIÓN    │                     │
│  │             │  │             │  │             │                     │
│  │  • Cálculo  │  │  • Pausa    │  │  • Puntos   │                     │
│  │  • Real-time│  │  • Reflexión│  │  • Badges   │                     │
│  │  • Desglose │  │  • Stats    │  │  • Rachas   │                     │
│  └─────────────┘  └─────────────┘  └─────────────┘                     │
│                                                                         │
└─────────────────────────────────────────────────────────────────────────┘
```
...
### 8.1 Mapa de Módulos PRO/BUSINESS

```
┌─────────────────────────────────────────────────────────────────────────┐
│                        MÓDULOS PREMIUM                                  │
├──────────────────────────────┬──────────────────────────────────────────┤
│         PRO ($149/mes)       │        BUSINESS ($299/mes)               │
├──────────────────────────────┼──────────────────────────────────────────┤
│ • Metas ilimitadas           │ • Todo de PRO                            │
│ • Deudas ilimitadas          │ • Multi-empresa (hasta 3)                │
│ • Coach IA "Paco"            │ • Facturación CFDI ilimitada             │
│ • Mapa Emocional completo    │ • Conexión SAT (CIEC)                    │
│ • Sync multi-dispositivo     │ • Reportes contables                     │
│ • OCR ilimitado              │ • Nómina integrada                       │
│ • Open Banking               │ • API access                             │
│ • Proyecciones IA            │ • Soporte prioritario                    │
│ • Reportes PDF               │ • Multi-usuario (5)                      │
│ • Vista compartida pareja    │ • Auditoría automática                   │
└──────────────────────────────┴──────────────────────────────────────────┘
```
...
## 10. UX/UI CON NEUROCIENCIA APLICADA
...
## 11. PSICOLOGÍA PERSUASIVA POSITIVA

### 11.1 Framework de Persuasión Ética
...
│  ✅ HACEMOS:                           ❌ NO HACEMOS:                    │
│                                                                         │
│  • Nudges hacia ahorro                 • Dark patterns                  │
│  • Friction para gastos grandes        • Guilt trips                    │
│  • Celebrar pequeños logros            • Shame tactics                  │
│  • Visualizar metas                    • Ocultar información            │
│  • Simplificar decisiones              • Crear urgencia falsa           │
│  • Mostrar progreso real               • Manipular emociones            │
│                                                                         │
└─────────────────────────────────────────────────────────────────────────┘
```
...
```
    ...
    ┌──────────┐         ┌──────────┐         ┌──────────┐         ┌──────────┐
    │ V1.0     │         │ V2.0     │         │ V3.0     │         │ V4.0     │
    │ MVP      │         │ Core     │         │ Premium  │         │ Scale    │
    ├──────────┤         ├──────────┤         ├──────────┤         ├──────────┤
    │• Wallet  │         │• Metas   │         │• Coach IA│         │• Open    │
    │• Planif. │─────────│• Deudas  │─────────│• Mapa    │─────────│  Banking │
    │• Tu $Hoy │         │• Gamif.  │         │  Emocional         │• Super-  │
    │• Anti-   │         │• Retos   │         │• CFDI    │         │  app     │
    │  impulso │         │• Vista   │         │• SAT     │         │• API     │
    │          │         │  pareja  │         │          │         │          │
    └──────────┘         └──────────┘         └──────────┘         └──────────┘
        │                    │                    │                    │
        ▼                    ▼                    ▼                    ▼
    5K usuarios          25K usuarios         100K usuarios        500K usuarios
```
...
┌─────────────────────────────────────────────────────────────────────────┐
│                                                                         │
│   NORTH STAR: "Usuarios con Racha de 7+ Días"                          │
│                                                                         │
│   Objetivo Q1 2026: 40% de usuarios activos                            │
│                                                                         │
└─────────────────────────────────────────────────────────────────────────┘
```
...
## 16. FRAMEWORK DE EVOLUCIÓN

### 16.1 Ciclo de Mejora Continua
...
### 16.2 Principios de Evolución

1. **Data-Driven:** Decisiones basadas en métricas, no opiniones
2. **User-Centric:** El usuario siempre primero
3. **Neuro-Validated:** Validar con principios de neurociencia
4. **Fail Fast:** Probar rápido, fallar barato
5. **Scale Later:** Primero funciona, después escala
