...
**Actualización:** 7 Perfiles Visuales + BYOK + Pricing Anti-Miedo + Contador Socio
...
2. [Los 7 Perfiles Visuales](#2-los-7-perfiles-visuales-para-landing-y-onboarding)
   - 2.A [Mapeo a 11 Perfiles Técnicos](#2a-mapeo-a-11-perfiles-técnicos-backend)
   - 2.B [Actores de Poder B2B](#2b-actores-de-poder-multiplicadores-b2b)
3. [Diferenciadores (The Pluses)](#3-diferenciadores-the-pluses)
4. [Sistema Tangram Universal](#4-sistema-tangram-universal-gratis-para-todos)
5. [Modelo BYOK + Pricing Anti-Miedo](#5-modelo-byok--pricing-anti-miedo)
6. [Monetización Viral y Growth Loops](#6-monetización-viral-y-growth-loops)
7. [Estrategia Enterprise & B2B](#7-estrategia-enterprise--b2b)
8. [Roadmap de Escalamiento Corporativo](#8-roadmap-de-escalamiento-corporativo)
...
### 1.1 Definición de Cara al Público

> **"Somos la primera plataforma financiera 100% mexicana que combina la potencia de la inteligencia artificial con la simplicidad que tu negocio necesita. No somos otro software contable más. Somos tu CFO digital: el aliado que entiende el SAT, habla tu idioma, y transforma cada peso en una decisión inteligente."**
...
```
PARA:     PyMEs mexicanas y profesionistas independientes
QUE:      Necesitan gestionar sus finanzas y cumplir con el SAT
SOMOS:    La plataforma financiera inteligente
QUE:      Automatiza lo tedioso y simplifica lo complejo
A DIFERENCIA DE: Contpaqi, Aspel, software genérico
PORQUE:   Fuimos diseñados desde cero para el México de 2026:
          IA integrada, CFDI nativo, precios justos, sin complicaciones
```
...
## 2. LOS 7 PERFILES VISUALES (PARA LANDING Y ONBOARDING)

> **ESTRATEGIA v4.0:** El usuario ve 7 perfiles visuales simples en landing/onboarding. Internamente, estos mapean a 11 perfiles técnicos con configuraciones específicas de widgets.

### 2.1 Los 7 Perfiles Visuales
...
│                                                                     │
│   ════════════ SOY PROFESIONAL ════════════                        │
│   🧮 CONTADOR          📦 E-COMMERCE      ⚕️ PROFESIONAL           │
│   (Despacho)           (Amazon/ML)         (Médico/Abogado)        │
│                                                                     │
└─────────────────────────────────────────────────────────────────────┘
```
...
## 2.A ACTORES DE PODER (MULTIPLICADORES B2B)

> **ESTOS SON NUESTROS MEJORES VENDEDORES.** Un contador trae 50 clientes. Son el motor del crecimiento.
...
- Auditoría EFOS de todos los proveedores de todos los clientes
...
├─────────────────────────────────────────────────────────────────────┤
│                                                                     │
│   🎁 EL CONTADOR USA GRATIS LA PLATAFORMA                          │
│      (Si trae ≥5 clientes a PRO/BUSINESS)                          │
│                                                                     │
│   💰 COMISIÓN RECURRENTE DEL 20%                                   │
│      (Mientras el cliente siga pagando)                            │
│                                                                     │
│   📊 EJEMPLO REAL:                                                  │
│   • Contador con 30 clientes PRO ($149/mes c/u)                    │
│   • Revenue mensual generado: $4,470                               │
│   • Comisión contador: $894/mes ($10,728/año)                      │
│   • Contador: GRATIS + INGRESO PASIVO                              │
│                                                                     │
│   🎯 RESULTADO: EL CONTADOR NOS VENDE 50 CLIENTES SIN ESFUERZO    │
│                                                                     │
└─────────────────────────────────────────────────────────────────────┘
```
...
- Vistas restringidas (inventario sí, saldo bancario no)

---

## 2.B CLIENTES HIGH-TICKET (REVENUE ESTABLE)

> **ESTOS CLIENTES PAGAN SIN DUDAR.** Alto volumen, dolor extremo, baja churn. Son nuestra base de ingresos estable.
...
- Inventario multi-canal sincronizado
...
│                                                               │
│   ┌─────────┐  ┌─────────┐  ┌─────────┐                      │
│   │FACTURAR │  │ CITAS   │  │POR COBRAR│                      │
│   │(3 clics)│  │  HOY: 4 │  │ $22,000 │                      │
│   └─────────┘  └─────────┘  └─────────┘                      │
└───────────────────────────────────────────────────────────────┘
```
...
- Referidos = médicos conocen médicos
...
```
┌─────────────────────────────────────────────────────────────────────┐
│                    PERFIL HÍBRIDO - VISTA DUAL                     │
├─────────────────────────────────────────────────────────────────────┤
│                                                                     │
│  ┌─────────────────────────────────────────────────────────────┐   │
│  │  🏢 MI NEGOCIO                              [Toggle: Solo]   │   │
│  │  ┌──────────┐  ┌──────────┐  ┌──────────┐                   │   │
│  │  │Facturación│  │  Clientes │  │   Flujo  │                   │   │
│  │  │ $45,000  │  │    23     │  │  +$12K   │                   │   │
│  │  └──────────┘  └──────────┘  └──────────┘                   │   │
│  └─────────────────────────────────────────────────────────────┘   │
│                                                                     │
...
│                                                                     │
│  ┌─────────────────────────────────────────────────────────────┐   │
│  │  🏠 MI PERSONAL                             [Toggle: Solo]   │   │
│  │  ┌──────────┐  ┌──────────┐  ┌──────────┐                   │   │
│  │  │ Gastos   │  │  Metas   │  │ Servicios │                   │   │
│  │  │ $8,500   │  │ 45% 🎯   │  │ $2,100   │                   │   │
│  │  └──────────┘  └──────────┘  └──────────┘                   │   │
│  └─────────────────────────────────────────────────────────────┘   │
│                                                                     │
│              [Ver Todo Junto] [Ocultar Personal]                   │
│                                                                     │
└─────────────────────────────────────────────────────────────────────┘
```
...
## 2. PÚBLICO OBJETIVO PRECISO

> **NOTA:** Esta sección complementa los 7 Perfiles con segmentación por plan de pago.

### 2.1 Segmentación Estratégica
...
## 3. DIFERENCIADORES (THE PLUSES)

### 3.1 Matriz de Diferenciadores Vendibles
...
## 4. SISTEMA TANGRAM UNIVERSAL (GRATIS PARA TODOS)

> **DECISIÓN ESTRATÉGICA CLAVE:** El Dashboard Tangram es el "Visual Killer Feature" - lo que hace que usuarios se queden y compartan. Por eso es GRATIS desde el plan Freemium.
...
```
┌─────────────────────────────────────────────────────────────────────┐
│                    FILOSOFÍA COST-BASED FREEMIUM                   │
├─────────────────────────────────────────────────────────────────────┤
│                                                                     │
│   "Solo cobramos por lo que NOS CUESTA a nosotros"                 │
│                                                                     │
│   ✅ GRATIS (0 costo servidor):                                    │
│   • Widgets que calculan en tu navegador                            │
│   • Gráficas y visualizaciones                                      │
│   • Drag & drop del dashboard                                       │
│   • Temas y personalización visual                                  │
│   • Exportar a PDF local                                            │
│                                                                     │
│   💰 PRO (costo de servidor):                                      │
│   • Sincronización SAT (API calls)                                  │
│   • Almacenamiento de facturas (storage)                            │
│   • IA que procesa tus datos (GPU)                                  │
│   • Reportes fiscales complejos (CPU)                               │
│   • Notificaciones SMS/WhatsApp (third-party)                       │
│                                                                     │
│   📣 MENSAJE: "No es que seamos tacaños. Es que eso cuesta dinero" │
│                                                                     │
└─────────────────────────────────────────────────────────────────────┘
```
...
## 5. MONETIZACIÓN VIRAL Y GROWTH LOOPS

> **OBJETIVO:** "Quiero que el sistema esté diseñado para crecer solo."

### 5.1 Los 3 Growth Loops Principales
...
├─────────────────────────────────────────────────────────────────────┤
│                                                                     │
│   Usuario Actual ──► Invita Amigo ──► Amigo se Registra            │
│        │                                      │                     │
│        │                                      │                     │
│        └──────────► 30% DESCUENTO ◄───────────┘                    │
│                    (ambos reciben)                                  │
│                                                                     │
│   🎯 REGLA: Máximo 3 amigos = 90% descuento                        │
│   🎯 BONUS: 4+ amigos = 100% (PRO gratis de por vida)*             │
│                                                                     │
│   *Solo si amigos mantienen cuenta activa 3+ meses                 │
│                                                                     │
└─────────────────────────────────────────────────────────────────────┘

┌─────────────────────────────────────────────────────────────────────┐
│                    LOOP 2: TASTING MENU (24 HRS)                   │
├─────────────────────────────────────────────────────────────────────┤
│                                                                     │
│   Usuario Freemium ──► 1 vez al mes ──► 24 hrs de PRO              │
│        │                                      │                     │
│        │                                      │                     │
│        └─────► Experimenta features ──► Quiere más ──► Upgrade     │
│                                                                     │
│   🎯 PSICOLOGÍA: Probar duele menos que imaginar                   │
│   🎯 TIMING: El día 15 del mes (cerca de pago de quincena)         │
│   🎯 NOTIFICACIÓN: "Tu día PRO está aquí. Tienes 24 horas."        │
│                                                                     │
│   Estadística esperada: 15-25% conversion después de tasting       │
│                                                                     │
└─────────────────────────────────────────────────────────────────────┘

┌─────────────────────────────────────────────────────────────────────┐
│                   LOOP 3: LOYALTY UNLOCKS                          │
├─────────────────────────────────────────────────────────────────────┤
│                                                                     │
│   Usuario Activo ──► 3 meses de uso ──► 3 Features PRO Gratis      │
│                                               │                     │
│                                               │                     │
│                                               └──► PARA SIEMPRE    │
│                                                                     │
│   🎯 LISTA DE FEATURES DESBLOQUEABLES:                             │
│                                                                     │
│   1. Modo Oscuro Premium (solo estético, $0 costo)                 │
│   2. Exportación PDF mejorada (logos, branding)                    │
│   3. Widget de Objetivos Avanzado                                  │
│   4. Calculadora ISR completa                                       │
│   5. Tema Tangram "Gold Edition"                                    │
│   6. Badge de "Usuario Leal" (social proof)                        │
│                                                                     │
│   El usuario elige 3 de estos 6. Gratis para siempre.              │
│                                                                     │
└─────────────────────────────────────────────────────────────────────┘
```
...
│   • Pop-ups agresivos: "ACTUALIZA YA!!"                            │
│   • Limitar features críticos en freemium                          │
│   • Hacer el producto inutilizable sin pagar                       │
│   • Dark patterns (botón de cancelar escondido)                    │
│   • Spam de emails promocionales                                   │
│                                                                     │
│   ✅ LO QUE SÍ HAREMOS:                                            │
│   • Mostrar features PRO con candado transparente                  │
│   • Explicar POR QUÉ es PRO (costo servidor)                       │
│   • Ofrecer upgrade en el momento justo (cuando lo necesitan)      │
│   • Hacer downgrade fácil y sin penalización                       │
│   • Mantener datos 12 meses después de cancelar                    │
│                                                                     │
│   📣 MANTRA: "Paga porque QUIERES, no porque DEBES"                │
│                                                                     │
└─────────────────────────────────────────────────────────────────────┘
```

### 5.5 Proyección de Crecimiento Viral

```
ESCENARIO CONSERVADOR (Factor viral 1.2):

Mes 0:    100 usuarios seed
Mes 1:    120 usuarios (+20% viral)
Mes 2:    144 usuarios
Mes 3:    173 usuarios
Mes 6:    373 usuarios
Mes 12:   1,439 usuarios

ESCENARIO OPTIMISTA (Factor viral 1.5):

Mes 0:    100 usuarios seed
Mes 1:    150 usuarios
Mes 2:    225 usuarios
Mes 3:    338 usuarios
Mes 6:    1,139 usuarios
Mes 12:   12,970 usuarios

META: Factor viral 1.3 sostenido = 5,000 usuarios en 12 meses con $0 en ads
```
...
## 6. ANÁLISIS DE VULNERABILIDADES COMPETITIVAS
...
## 7. ESTRATEGIA ENTERPRISE & B2B

### 7.1 ¿Es Viable Ofrecer a Bancos y Corporativos?

**RESPUESTA CORTA: Sí, pero en Fase 2 (2027+), no ahora.**
...
4. **2027 Q2+:** Aceptar 1-2 clientes enterprise piloto con criterios estrictos.
...
```
FASE 1 (2025-2026): PRODUCTO
├── 100% enfocados en PyMEs e individuos
├── Construir marca y reputación
├── Perfeccionar el producto
└── Generar revenue sostenible

FASE 2 (2027): PLATAFORMA
├── Abrir APIs públicas
├── Marketplace de integraciones
├── White-label para distribuidores
└── Primer piloto enterprise (1-2 clientes selectos)

FASE 3 (2028+): ECOSISTEMA
├── División Enterprise con equipo dedicado
├── Partnerships con bancos
├── Expansión LATAM
...
## 8. ROADMAP DE ESCALAMIENTO CORPORATIVO

### 8.1 Timeline Realista

```
2025 Q4 - 2026 Q2: CONSTRUIR PRODUCTO
└── MVP → Beta → Lanzamiento público
└── Primeros 1,000 usuarios pagos
└── NPS > 50, retención > 80%

2026 Q3 - Q4: CRECER BASE SMB
└── 10,000 usuarios
└── Casos de éxito documentados
└── Revenue $50K MRR

2027 Q1 - Q2: PREPARAR ENTERPRISE
└── APIs públicas documentadas
└── Certificaciones de seguridad (SOC2, ISO 27001 en proceso)
└── Primer piloto white-label con fintech aliada

2027 Q3+: ESCALAR ENTERPRISE
└── Equipo dedicado de 2-3 personas
└── Pipeline de 5-10 prospectos enterprise
└── Meta: 20% de revenue de B2B
```
...
**Documento creado:** 01 Diciembre 2025  
**Próxima revisión:** Después del lanzamiento Beta (Enero 2026)  
**Responsable:** Equipo de Estrategia
